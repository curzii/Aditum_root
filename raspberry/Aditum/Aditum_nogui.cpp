...
void load_templates()
{
	ifstream f_detect_template 	{ "/home/pi/Aditum/detect_template.dat" };
	ifstream f_data_template 	{ "/home/pi/Aditum/dump_template.dat" };
...
string logostring()
{
	ifstream logo 	{ "/home/pi/Aditum/logo.dat" };
...
vector<vector<string>> database_read()
{
	...
	std::ifstream file("/home/pi/Aditum/database.csv");					//open database file
    std::string raw; 
...
void write_log(vector<string> log, vector<string> csv)
{
	ofstream file("/home/pi/Aditum/log.txt", ios_base::out | ios_base::app );
	for (int i = 0; i < log.size(); i++)
		file << log[i];
	file.close();
	ofstream csvfile("/home/pi/Aditum/log.csv", ios_base::out | ios_base::app );
